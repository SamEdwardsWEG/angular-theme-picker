...
@Component({
  ...
  template: `
    <mat-toolbar>
      Angular Color Switcher
      <div class="flex-stretch"></div>
      <mat-slide-toggle labelPosition="before" (toggleChange)="themeService.changeDarkMode()">{{ themeService.darkMode ? 'Light' : 'Dark' }} mode?</mat-slide-toggle>
